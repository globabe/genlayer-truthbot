...
import { User, Eye, EyeOff, Crown } from "lucide-react";
  ...
  return (
    <div className="space-y-4">
      ...
      <div className="space-y-3">
        {slots.map((i) => {
          const hasPlayer = i < players.length;
          const isLiar = isResolved && liarIndex === i;
          const isClean = isResolved && liarIndex !== i;
                    ...
                    <div className="rounded-lg bg-secondary/50 p-3">
                      <p className="text-sm text-foreground/80 leading-relaxed">
                        {isResolved ? (
                          ...
                          <span className="italic text-muted-foreground">Claim hidden until reveal</span>
                        )}
                      </p>
                    </div>
                  )}
